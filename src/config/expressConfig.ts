...
export default function expressConfig(): Express {
    ...
    //Configure routes
    app.use(express.static("/home/trilogic/Downloads/Exercices-master/frontend"))
    app.get("/", (req, res) => {
        res.sendFile("/home/trilogic/Downloads/Exercices-master/frontend/index.html")
    })
    app.get("/login", (req, res) => {
        res.sendFile("/home/trilogic/Downloads/Exercices-master/frontend/auth/login/index.html")
    })
    app.get("/signup", (req, res) => {
        res.sendFile("/home/trilogic/Downloads/Exercices-master/frontend/auth/signup/index.html")
    })
